...
latex_documents = [
    (master_doc, "index.tex", "Supplementary material", "Phil Austin", "manual")
]
...
man_pages = [(master_doc, "curric", "curric Documentation", [author], 1)]
